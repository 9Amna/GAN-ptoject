...
def train_fn(train_dl, G, D, criterion_bce, criterion_mae, optimizer_g, optimizer_d):
    ...
    for i, (input_img, real_img) in enumerate(tqdm(train_dl)):
        ...
        real_label = torch.ones(input_img.size()[0], 1, 8, 8)
        fake_label = torch.zeros(input_img.size()[0], 1, 8, 8)
        # Generator
...
def load_args(default_config=None):
    ...
    parser.add_argument('--resume', metavar='CKPT', default='/content/drive/MyDrive/savings',
